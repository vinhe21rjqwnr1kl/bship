...
return [
    ...
    |
    |       - token:    Your Telegram Bot'.htaccess Access Token.
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '6232784055:AAFOmIJ5qrMBy5VkbZQ5l-frN16wYFQLBcQ'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'https://butl.vn'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://butl.vn'),
            'commands' => [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Using Laravel'.htaccess IoC container, we can easily type hint dependencies in
    | our command'.htaccess constructor and have them automatically resolved for us.
    |
    | Default: true
    | Possible Values: (Boolean) "true" OR "false"
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If you'd like to use the SDK'.htaccess built in command handler system,
