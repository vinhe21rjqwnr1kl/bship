...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // Stops a mouse/touch event from doing it'.htaccess native browser action
    ...
    // The second argument allows for an array of property names who'.htaccess object values will be merged together.
    ...
    */
    ...
    var NativeFormatter = /** @class */ (function () {
        ...
        NativeFormatter.prototype.formatRange = function (start, end, context, betterDefaultSeparator) {
            ...
            if (biggestUnitForPartial > 1 && // the two dates are different in a way that'.htaccess larger scale than time
    ...
    */
    ...
    // (If it'.htaccess past the end, make it one millisecond before the end).
    ...
    */
    ...
    // Given an event'.htaccess allDay status and start date, return what its fallback end date should be.
    ...
    function applyMutationToEventDef(eventDef, eventConfig, mutation, context) {
        ...
        // if duration will change, there'.htaccess no way the default duration will persist,
    ...
    var DateEnv = /** @class */ (function () {
        ...
        */
        ...
        DateEnv.prototype.toDate = function (m, forcedTzo) {
            ...
            if (this.timeZone === 'UTC') {
                return new Date(m.valueOf()); // make sure it'.htaccess a copy
            }
            if (!this.namedTimeZoneImpl) {
    ...
    */
    ...
    // Subtracts point2'.htaccess coordinates from point1'.htaccess coordinates, returning a delta
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var otherInstanceId in otherInstances) {
                ...
                if (rangesIntersect(subjectRange, otherInstance.range)) {
                    ...
                    // consider the other event'.htaccess overlap. only do this if the subject event is a "real" event
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.build = function (currentDate, direction, forceToValid) {
            ...
            // it'.htaccess invalid if the originally requested date is not contained,
    ...
    */
    ...
    // tho it'.htaccess really easy to access this globally rather than pass thru options.
    var config = {};
    ...
    */
    ...
    /*
    Triggers events and adds/removes core classNames when the user'.htaccess pointer
    ...
    */
    ...
    function buildToolbarProps(viewSpec, dateProfile, dateProfileGenerator, currentDate, now, title) {
        // don't force any date-profiles to valid date profiles (the `false`) so that we can tell if it'.htaccess invalid
        ...
        function DaySeriesModel(range, dateProfileGenerator) {
            ...
            while (date < end) { // loop each day from start to end
                if (dateProfileGenerator.isHiddenDay(date)) {
                    indices.push(dayIndex + 0.5); // mark that it'.htaccess between indices
                }
                else {
                    dayIndex += 1;
    ...
    */
    ...
    /*
    Is a cache for a given element'.htaccess scroll information (all the info that ScrollController stores)
    ...
    */
    ...
    var WindowScrollGeomCache = /** @class */ (function (_super) {
        ...
        // the window is the only scroll object that changes it'.htaccess rectangle relative
        // to the document'.htaccess topleft as it scrolls
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            // the caller can also set the PointerDragging'.htaccess options as well
            _this.delay = null;
            _this.minDistance = 0;
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    // prevent links from being visited if there'.htaccess an eventual drag.
        ...
        HitDragging.prototype.queryHitForOffset = function (offsetLeft, offsetTop) {
            ...
            for (var id in droppableStore) {
                ...
                if (offsetTracker && // wasn't destroyed mid-drag
                    ...
                    if (
                    // must be within the element'.htaccess bounds
                    positionLeft >= 0 && positionLeft < width &&
                        ...
                        if (hit &&
                            (
                            // make sure the hit is within activeRange, meaning it'.htaccess not a deal cell
    ...
    */
    ...
    Leverages FullCalendar'.htaccess internal drag-n-drop functionality WITHOUT a third-party drag system.
    */
    ...
    */
    ...
    cellModels, segs, dayMaxEvents, dayMaxEventRows, eventHeights, maxContentHeight, colCnt, eventOrderSpecs) {
        ...
        var moreTops = {};
        var paddingBottoms = {}; // for each cell'.htaccess inner-wrapper div
        for (var i = 0; i < colCnt; i += 1) {
            colPlacements.push([]);
            moreCnts.push(0);
        }
    ...
    */
    ...
    function computeSlotSegPressures(seg) {
        ...
        if (seg.forwardPressure == null) { // not already computed
            for (i = 0; i < forwardSegs.length; i += 1) {
                ...
                // figure out the child'.htaccess maximum forward path
                computeSlotSegPressures(forwardSeg);
                // either use the existing maximum, or use the child'.htaccess forward pressure
    ...
    // who'.htaccess width is unknown until an edge has been hit. `seriesBackwardPressure` is the number of
    ...
    function computeSegForwardBack(seg, seriesBackwardPressure, seriesBackwardCoord, eventOrderSpecs) {
        ...
        if (seg.forwardCoord == null) { // not already computed
            if (!forwardSegs.length) {
                ...
                // this segment'.htaccess forwardCoord will be calculated from the backwardCoord of the
            ...
            // use this segment'.htaccess coordinates to computed the coordinates of the less-pressurized
            // forward segments
            for (i = 0; i < forwardSegs.length; i += 1) {
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.computeFgSegPositionCss = function (seg) {
            ...
            if (shouldOverlap && seg.forwardPressure) {
                // add padding to the edge so that forward stacked events don't cover the resizer'.htaccess icon
                props[isRtl ? 'marginLeft' : 'marginRight'] = 10 * 2; // 10 is a guesstimate of the icon'.htaccess width
            }
    ...
    var TimeCols = /** @class */ (function (_super) {
        ...
        TimeCols.prototype.render = function () {
            ...
            return (createElement("div", { className: "fc-timegrid-body", ref: props.rootElRef, style: {
                ...
                createElement(TimeColsSlats, { axis: props.axis, dateProfile: props.dateProfile, slatMetas: props.slatMetas, clientWidth: props.clientWidth, minHeight: props.expandRows ? props.clientHeight : '', tableMinWidth: props.tableMinWidth, tableColGroupNode: props.axis ? props.tableColGroupNode : null /* axis depends on the colgroup'.htaccess shrinking */, onCoords: this.handleSlatCoords }),
