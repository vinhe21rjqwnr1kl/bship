                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('Controllers > UsersController > create')
                            <a href="{{ route('custumer.admin.bannercreate') }}" class="btn btn-xs btn-primary">Tạo
                                Banner</a>
                        @endcan
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive-lg mb-0">
                                ...
                                @forelse ($banner as $banners)
                                    <tr>
                                        <td> {{ $i++ }} </td>
                                        <td><img src="{{ $banners->url }}" width="70" height="50"
                                                 alt="{{$banners->title}}"></td>
                                        {{--                                    <td> <img src="https://daily.bship.vn/public/uploads/20240423/d8fa4e87353f13660a17587c10e856ff.jpg" width="70" height="50"></td>--}}
                                        <td> {{ $banners->title }} </td>
                                        <td> {{ $banners->index }} </td>
                                        <td> {{ $banners->direct_url }} </td>
                                        <td> {{ $banner_types[$banners->type] }} </td>
                                        <td>
                                            @if ($banners->status == 1)
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('custumer.admin.bannerdelete', $banners->id) }}"
