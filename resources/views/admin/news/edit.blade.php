                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="status" id="status" class="default-select form-control">
                                            <option {{ $news->status == 1 ? 'selected' : '' }} value="1"> Hiển thị</option>
                                            <option {{ $news->status == 0 ? 'selected' : '' }} value="0">Không hiển thị</option>
                                        </select>
                                    </div>
                                    <div class="accordion__body p-4 collapse show" id="with-feature-image"
                                        ...
                                        <div class="featured-img-preview img-parent-box">
                                            ...
                                            <img src="{{ $news->image ?? asset('images/noimage.jpg') }}" class="avatar img-for-onchange"
                                                 alt="{{ $news->title ?? __('common.image') }}" width="100px" height="100px"
                                                 title="{{ $news->title ?? __('common.image') }}">
