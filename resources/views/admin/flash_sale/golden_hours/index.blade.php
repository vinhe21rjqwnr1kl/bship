            ...
            <div class="col-xl-12">
                <div class="card accordion accordion-rounded-stylish accordion-bordered" id="search-sec-outer">
                    ...
                    <div class="card-body collapse accordion__body {{ $show }}" id="rounded-search-sec"
                        ...
                        <form action="{{ route('admin.flash_sale.golden_hours') }}" method="get">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-6 col-md-6">
                                    ...
                                    <a href="{{ route('admin.flash_sale.golden_hours') }}" class="btn btn-danger">Nhập Lại</a>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('Controllers > FlashSaleController > createGoldenHours')
                            <a href="{{ route('admin.flash_sale.golden_hours.create') }}" class="btn btn-xs btn-primary">Tạo</a>
                        @endcan
                    </div>
                                ...
                                @forelse ($items as $item)
                                    <tr>
                                        ...
                                        <td style="width: 80px; word-wrap: break-word;">
                                            <a href="{{ route('admin.flash_sale.golden_hours.edit', $item->id) }}"
                                    ...
                                    <form id="delete-form-{{ $item->id }}" method="POST"
                                          action="{{ route('admin.flash_sale.golden_hours.destroy', $item->id) }}" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                @empty
