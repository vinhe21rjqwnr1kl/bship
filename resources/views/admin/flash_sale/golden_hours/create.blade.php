...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <form action="{{ route('admin.flash_sale.golden_hours.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer pt-0 text-end">
                    ...
                    <a href="{{ route('admin.flash_sale.golden_hours') }}" class="btn btn-danger">Quay lại</a>
                </div>
            </form>
        </div>
    </div>
