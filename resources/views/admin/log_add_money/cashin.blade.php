...
@section('content')
            ...
            <div class="col-xl-12">
                <div class="card accordion accordion-rounded-stylish accordion-bordered" id="search-sec-outer">
                    ...
                    <div class="card-body collapse accordion__body {{ $show }}" id="rounded-search-sec"
                        ...
                        {{ Form::model(request()->all(), array('route' => array('log_add_money.admin.cashin'), 'method' => 'get')) }}
                        ...
                        <div class="row">
                            ...
                            <div class=" col-sm-6 col-md-3 col-lg-4 col-xl-3 text-sm-end">
                                <input type="submit" name="search" value="Tìm" class="btn btn-primary me-2"> <a
                                    href="{{ route('log_add_money.admin.cashin') }}" class="btn btn-danger">Nhập
                                    Lại</a>
                            </div>
                        </div>
                        {{ Form::close() }}
                                ...
                                @forelse ($LogAddMoneyRequest as $log)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if($log->status == 1)
                                                <a href="{{ route('log_add_money.admin.cashin.accept', $log->id) }}"
    ...
    <script>
        ...
        exampleModal.addEventListener('show.bs.modal', function (event) {
            ...
            var deleteLinkHref = "{{ route('log_add_money.admin.cashin.reject', ':id') }}";
