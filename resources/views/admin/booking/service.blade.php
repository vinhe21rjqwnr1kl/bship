		...
		<div class="col-xl-12">
			<div class="card accordion accordion-rounded-stylish accordion-bordered" id="search-sec-outer">
				...
				<div class="card-body collapse accordion__body {{ $show }}" id="rounded-search-sec" data-bs-parent="#search-sec-outer">
					<form action="{{ route('booking.admin.service') }}" method="get">
					@csrf
						...
						<div class="row">
							...
							<input type="submit" name="search" value="Tìm kiếm" class="btn btn-primary me-2"> 
								<a href="{{ route('booking.admin.service') }}" class="btn btn-danger">Nhập Lại</a>
		...
		<div class="col-xl-12">
			...
			<div class="card-header">
                    <h4 class="card-title"></h4>
                        <a href="{{ route('booking.admin.servicecreate') }}" class="btn btn-primary">Tạo dịch vụ</a>
                </div>
				<div class="card-body">
								...
								@forelse ($drivers as $page)
									<tr>
										...
										<td class="text-center">
												<a href="{{ route('booking.admin.serviceedit', $page->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
