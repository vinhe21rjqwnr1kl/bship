...
<form action="{{ route('booking.admin.servicestore') }}" method="post" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-md-12">
				<div class="row">
							...
							<div class="card-body p-4">
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<input  name="cost" class="form-control" id="cost" placeholder="" value="{{ old('cost') }}">
										@error('cost')
											<p class="text-danger">
												{{ $message }}
											</p>
									...
									<div class="form-group col-md-6">
										...
										<input  name="org_cost" class="form-control" id="org_cost" placeholder="" value="{{ old('org_cost') }}">
										@error('org_cost')
											<p class="text-danger">
												{{ $message }}
											</p>
