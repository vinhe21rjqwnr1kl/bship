		...
		<div class="col-xl-12">
			...
			<div class="card-header">
                    <h4 class="card-title"></h4>
                        <a href="{{ route('booking.admin.suppliercreate') }}" class="btn btn-primary">Thêm thông tin đặt lịch</a>
                </div>
				<div class="card-body">
						...
						<table class="table table-responsive-lg mb-0">
							<thead class="">
								<tr>
									...
									<th> <strong> Tên đại lý </strong> </th>
							...
							<tbody>
								...
								@forelse ($drivers as $page)
									<tr>
										...
										<td>{{$page->name_a}} </td>
										<td>{{$page->name}} </td>
										<td> <img src="{{ $page->thumbnail }}" width="70" height="50"></td>

										<td>{{$page->address_text }} </td>
										<td>{{$page->lat }} </td>
										<td>{{$page->lng }} </td>
										...
										<td class="text-center">
												<a href="{{ route('booking.admin.supplieredit', $page->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
