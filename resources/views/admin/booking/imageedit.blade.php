...
<form action="{{ route('booking.admin.imageupdate', $driver->id ) }}" method="post" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-md-12">
				<div class="row">
													...
													<div class="accordion__body p-4 collapse show" id="with-feature-image" data-bs-parent="#accordion-feature-image">
														<div class="featured-img-preview img-parent-box"> 
															@if(!empty($driver->image))
																<img src="{{ $driver->image }}" class="avatar img-for-onchange"  width="100px" height="100px"> 
															@else
