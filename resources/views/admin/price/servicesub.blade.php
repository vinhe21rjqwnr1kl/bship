							...
							<tbody>
								...
								@forelse ($Services as $page)
									<tr>
										...
										<textarea name="policy_content" id="policy_content" class="form-control h-100" rows="4">{{ $page->policy_content}}</textarea>
                                        ...
                                        @can('Controllers > UsersController > edit')
                                            <a href="{{ route('price.admin.servicesubedit', $page->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                        @endcan
