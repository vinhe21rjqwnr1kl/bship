...
<div class="container-fluid">
	...
	<div class="card">
		<form action="{{ route('price.admin.servicesubupdate', $Services->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
			<div class="card-body">
						...
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label>Thứ tự </label>
									<input type="text" name="is_show" id="is_show"  class="form-control" autocomplete="name"  value="{{ $Services->is_show}}">
									@error('is_show')
			                            <p class="text-danger">
			                                {{ $message }}
			                            </p>
								...
								<div class="form-group col-md-12">
									...
									<textarea name="policy_content" id="policy_content" class="form-control h-100" rows="12">{{ $Services->policy_content}}</textarea>
