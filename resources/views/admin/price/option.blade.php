		...
		<div class="col-xl-12">
			<div class="card accordion accordion-rounded-stylish accordion-bordered" id="search-sec-outer">
				...
				<div class="card-body collapse accordion__body {{ $show }}" id="rounded-search-sec" data-bs-parent="#search-sec-outer">
					<form action="{{ route('price.admin.option') }}" method="get">
					@csrf
						...
						<div class="row">
							...
							<input type="submit" name="search" value="Tìm kiếm" class="btn btn-primary me-2"> 
								<a href="{{ route('price.admin.option') }}" class="btn btn-danger">Nhập Lại</a>
			...
			<div class="card">
				<div class="card-header">
                    <h4 class="card-title"></h4>
                        <a href="{{ route('price.admin.optioncreate') }}" class="btn btn-primary">Tạo dịch vụ riêng</a>
                </div>
				<div class="card-body">
						...
						<table class="table table-responsive-lg mb-0">
							<thead class="">
								<tr>
									...
									<th> <strong> Tỉ lệ tiền </strong> </th>
								...
								@forelse ($Prices as $page)
									<tr>
                                        ...
                                        @can('Controllers > UsersController > edit')
                                            <a href="{{ route('price.admin.optionedit', $page->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                        @endcan
