						...
						<table class="table table-responsive-lg mb-0">
							<thead class="">
								<tr>
									...
									<th> <strong> Hiển thị ( Trang chủ ) </strong> </th>
									<th> <strong> Thứ tự </strong> </th>
									<th> <strong> Trạng thái </strong> </th>
									<th> <strong> Kinh doanh </strong> </th>
								...
								@forelse ($Services as $page)
									<tr>
                                        ...
                                        @can('Controllers > UsersController > edit')
                                            <a href="{{ route('price.admin.serviceedit', $page->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                        @endcan
