...
//        $resultQuery->leftJoin('cf_services_detail', 't_discount.services_detail_id', '=', 'cf_services_detail.id')
        ...
        $resultQuery->select(
            ...
            'go_info.id as go_info_id',
            'go_info.pickup_address as pickup_address',
...
//        return ["Mã khuyến mãi",  "Tiêu đề", "Giá trị", "Trạng thái",  "Ngày bắt đầu", "Ngày kết thúc", "Ngày tạo", "Trạng thái sử dụng" ];
        return ["Mã khuyến mãi", "Mã chuyến", "Điểm đón", "Loại", "Dịch vụ", "Ngày dùng", "Tên khách hàng", "SĐT khách hàng", "Tên tài xế", "SĐT tài xế"];
